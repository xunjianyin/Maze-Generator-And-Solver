...
const ControlsPanel: React.FC<ControlsPanelProps> = ({
  ...
  const solverAlgorithms = [
    { value: 'bfs', label: 'Breadth-First Search', description: 'Finds shortest path' },
    { value: 'dfs', label: 'Depth-First Search', description: 'Explores deep paths first' },
    { value: 'astar', label: 'A* Search', description: 'Heuristic-based optimal pathfinding' },
  ];
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-gray-500 mt-2 italic">
            {solverAlgorithms.find(a => a.value === solverAlgorithm)?.description}
          </p>
        </div>
              ...
              <div className="space-y-6 pt-4 border-t border-gray-200">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center p-3 rounded-xl border-2 border-transparent hover:border-blue-200 cursor-pointer transition-all">
                      <input
                        type="radio"
                        value="manual"
