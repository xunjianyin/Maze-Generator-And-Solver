    ...
    <div className="space-y-6">
      ...
      {isComplete && (
        ...
        >
          <div className="flex items-center justify-center mb-6">
            <motion.div 
              className="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center shadow-2xl"
              animate={{ 
                scale: [1, 1.1, 1],
                rotate: [0, 5, -5, 0]
              }}
      ...
      >
        <div className="flex items-center mb-4">
          ...
          <h4 className="font-semibold text-gray-800">Algorithm Info</h4>
        </div>
        <div className="text-xs text-gray-600 space-y-3">
          <div className="p-3 bg-gray-50 rounded-lg">
            <p className="font-semibold text-gray-700 mb-1">DFS Generation:</p>
            <p>Creates mazes with long corridors and fewer dead ends.</p>
          </div>
          <div className="p-3 bg-gray-50 rounded-lg">
            <p className="font-semibold text-gray-700 mb-1">Prim's:</p>
            <p>Creates more balanced mazes with uniform path distribution.</p>
          </div>
          <div className="p-3 bg-gray-50 rounded-lg">
            <p className="font-semibold text-gray-700 mb-1">Kruskal's:</p>
            <p>Creates mazes with many short paths and more complexity.</p>
          </div>
        </div>
      </motion.div>
    </div>
